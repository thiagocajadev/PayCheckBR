            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="bg-foreground text-white border-b-neo border-foreground font-black text-xs uppercase tracking-widest">
                        ...
                        <th className="p-3 border-r-2 border-white/10 text-white/90">Nome EMV (Protocolo)</th>
                        <th className="p-3 w-16 text-center border-r-2 border-white/10 text-white/90">Tam</th>
